...
options(gargle_oauth_email = "jed@jedidiahcarlson.com")
gs4_auth(path="~/client_secret_446840510584-7hve5qt78osvgilgfa3s1reak1hloe07.apps.googleusercontent.com.json")
```
...
cv_data$experience %>%
  ...
  detailed_entries(what = company, when = dates, with = position, why = details, .protect = FALSE)
